...
class PathFinder():
	def __init__(self, window_size):
		...
		self.check_out_1 = Data('Check_out_1',(115//2,40//2),0,(100 // 2,25 // 2),(100 // 2,52 // 2))
		self.check_out_2 = Data('Check_out_2',(115//2,96//2),0,(100 // 2,73 // 2),(100,100 // 2))
		self.idx = []
		self.idx_name = []
